...
class PenredDicomPanel(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        if scene and hasattr(scene, "penred_settings"):
            ...
            split.label(text="Enclosure Margin")
            split.prop(dicomproperties, "enclosureMargin", text="")
            split.label(text="cm")
